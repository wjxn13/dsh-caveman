...
var CavemanPanel_default = { "section": "section_wl13vp", "card": "card_1tafk", "row": "row_2fa2", "label": "label_1p5sz8", "value": "value_1unypd", "actions": "actions_1ftekn1", "notes": "notes_1qipc1", "notesTitle": "notesTitle_1xoosuv" };
...
function apply(ctx) {
  ...
  console.error("[dsh-caveman client] connection present:", connection !== void 0, "isLoopback:", connection?.isLoopback);
  const scope = ctx.settingsScope.bind({ namespace: "dsh-caveman" });
